...
// -----------------------------------------------------------------------------
// MOCK: SharedPreferences (replaces the real package)
// -----------------------------------------------------------------------------
  ...
  void loadMockData() {
    posts = [
      ...
      Post(
        ...
        content: 'What is the best way to manage state in large Flutter apps?',
        votes: 12,
      ),
      Post(
        id: '3',
        title: 'Dart Tips & Tricks',
        content: 'A fun fact about Dart extension methods.',
        votes: 28,
      ),
    ];
    notifyListeners();
...
class AppRouter {
  ...
  static PageRouteBuilder _buildRoute(RouteSettings s, Widget w) {
